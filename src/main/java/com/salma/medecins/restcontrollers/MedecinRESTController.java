package com.salma.medecins.restcontrollers;
...
public class MedecinRESTController {
	...
	@RequestMapping(value="/medscat/{idSer}",method = RequestMethod.GET)
	public List<Medecin> getProduitsByCatId(@PathVariable("idSer") Long idSer) {
	return medecinService.findByServicemIdSer(idSer);
	}
	}
